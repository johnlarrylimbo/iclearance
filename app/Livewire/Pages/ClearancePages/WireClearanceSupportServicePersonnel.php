...
#[Lazy]
#[Layout('layouts.app')]
class WireClearanceSupportServicePersonnel extends Component
{
  ...
  public $search;
    ...
    if(!$this->search){
			$clearance = $this->clearance_service->loadClearanceSupportServicerPersonnel()->paginate(10);
			return $clearance;
		}
		else{
			$clearance = $this->clearance_service->searchClearanceSupportServicerPersonnelByKeyword($this->search)->paginate(10);
			return $clearance;
		}
	}
  ...
  #[Computed]
	...
	public function render(){
		return view('livewire.pages.clearance-pages.clearance-support-service-personnel');
	}
